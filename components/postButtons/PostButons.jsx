...
export default function PostButtons({
  ...
  return (
    <div className="flex gap-2 justify-between text-twitterLightGray text-sm w-full">
      <Link href={`/${username}/status/${postId}`} className="flex gap-1 items-center">
      ...
      >
        <div className="relative w-6 h-6">
          <div className={(big ? '-top-[0.45rem] -left-0.5' : '-top-[0.3rem] left-0.5')+" absolute group-hover:bg-twitterRose/15  transition-all duration-200 ease-in-out rounded-full p-2"}> 
